...
const Dashboard = () => {
  ...
  const { belumHafalan, belumMurojaah, topHafalan, stagnant, todayHafalanCount, todayMurojaahCount } = useHomePage();
        ...
        <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-2xl p-4 mt-4">
          ...
          <div className="space-y-3">
            {topHafalan.length > 0 && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-[10px] text-primary-foreground/70">Penambahan Hafalan Terbanyak</span>
                </div>
            ...
            {stagnant.length > 0 && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-[10px] text-primary-foreground/70">Stagnan</span>
                </div>
                <div className="space-y-1.5">
            ...
            {topHafalan.length === 0 && stagnant.length === 0 && (
              <p className="text-xs text-primary-foreground/50 text-center py-2">Belum ada data hafalan hari ini</p>
            )}
          </div>
        </div>
      </div>
